...
static char i2c_write(unsigned char slave_addr, unsigned char reg_addr, unsigned char length, unsigned char *data) {
    // TODO
    return -1;
}

static char i2c_read(unsigned char slave_addr, unsigned char reg_addr, unsigned char length, unsigned char *data) {
    // TODO
    return -1;
}
...
static inline void reg_int_cb(struct int_param_s* p) {
    // TODO
}
// TODO
#define log_i(...) Linfo(__VA_ARGS__)
// TODO
#define log_e(...) Lerror(__VA_ARGS__)
